...
import 'package:opencv_4/factory/miscellaneoustransform/refineboardcorners_factory.dart';
...
class Cv2 {
  ...
  /// Native contour-based corner refinement:
  /// findContours + approxPolyDP + cornerSubPix (platform-dependent support).
  ///
  /// Returns `null` when native method is unavailable or fails.
  static Future<Map<dynamic, dynamic>?> refineBoardCorners({
    ...
    return RefineBoardCornersFactory.refineBoardCorners(
      pathFrom: pathFrom,
      pathString: pathString,
      corners: corners,
      data: data,
